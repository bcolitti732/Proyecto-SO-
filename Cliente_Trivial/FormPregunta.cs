...
namespace Trivial
{
    ...
    {
        //Devuelve 1 si acierta y 0 si falla
        string categoria;
        ListaPreguntas geografia = new ListaPreguntas(@".\\geo.txt");
        ListaPreguntas historia = new ListaPreguntas(@".\\history.txt");
        ListaPreguntas ciencia = new ListaPreguntas(@".\\science.txt");
        ListaPreguntas deportes = new ListaPreguntas(@".\\sport.txt");
        ListaPreguntas entretenimiento = new ListaPreguntas(@".\\culture.txt");
        ListaPreguntas tecnologia = new ListaPreguntas(@".\\tech.txt");
        Pregunta pregunta;
        ...
        {
            //Seleccionamos una pregunta random de la categoría correspondiente y ponemos el fondo del form de la categoria correspondiente
